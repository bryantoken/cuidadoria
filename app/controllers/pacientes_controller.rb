class PacientesController < ApplicationController
  ...
  before_action :check_admin, only: [:new, :create, :edit, :update, :index]
  ...
  private
    ...
    def paciente_params
      params.require(:paciente).permit(:nome_completo, :cpf, :data_nascimento, :enfermidade, :estado_civil, :endereco_completo)
    end
    
    def check_admin
      unless current_user.admin?
        redirect_to pacientes_path, alert: "Você não tem permissão"
      end
    end
end
